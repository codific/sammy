                ...
                $(document).on('click.editable', function(e) {
                    var $target = $(e.target), i,
                        exclude_classes = ['.editable-container', 
                                           '.ui-datepicker-datepicker-header',
                                           '.editable-datepicker', //in inline mode datepicker is rendered into body
                                           '.modal-backdrop', 
...
(function( $ ) {
	...
	var Datepicker = function(element, options) {
		...
		if(this.isInline) {
			this.picker.addClass('editable-datepicker-inline').appendTo(this.element);
		} else {
			this.picker.addClass('editable-datepicker-dropdown dropdown-menu');
		}

		if (this.o.rtl){
			this.picker.addClass('editable-datepicker-rtl');
	...
	Datepicker.prototype = {
		...
		fillDow: function(){
			...
			if(this.o.calendarWeeks){
				...
				html += cell;
				this.picker.find('.editable-datepicker-days thead tr:first-child').prepend(cell);
			}
			while (dowCnt < this.o.weekStart + 7) {
				html += '<th class="dow">'+dates[this.o.language].daysMin[(dowCnt++)%7]+'</th>';
			}
			html += '</tr>';
			this.picker.find('.editable-datepicker-days thead').append(html);
		},
		...
		fillMonths: function(){
			...
			this.picker.find('.editable-datepicker-months td').html(html);
		},
		...
		fill: function() {
			var d = new Date(this.viewDate),
				...
				tooltip;
			this.picker.find('.editable-datepicker-days thead th.editable-datepicker-switch')
			...
			this.picker.find('.editable-datepicker-days tbody').empty().append(html.join(''));
			var currentYear = this.date && this.date.getUTCFullYear();

			var months = this.picker.find('.editable-datepicker-months')
						.find('th:eq(1)')
							.text(year)
							.end()
			...
			var yearCont = this.picker.find('.editable-datepicker-years')
								.find('th:eq(1)')
									.text(year + '-' + (year + 9))
									.end()
								.find('td');
				...
				switch(target[0].nodeName.toLowerCase()) {
					case 'th':
						switch(target[0].className) {
							case 'editable-datepicker-switch':
								this.showMode(1);
								break;
							case 'prev':
							case 'next':
		...
		showMode: function(dir) {
			...
			*/
			//this.picker.find('>div').hide().filter('.editable-datepicker-'+DPGlobal.modes[this.viewMode].clsName).show();
			this.picker.find('>div').hide().filter('.editable-datepicker-'+DPGlobal.modes[this.viewMode].clsName).css('display', 'block');
			this.updateNavArrows();
		}
	};
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="far fa-arrow-left"/></th>'+
								'<th colspan="5" class="editable-datepicker-switch"></th>'+
								'<th class="next"><i class="far fa-arrow-right"/></th>'+
							'</tr>'+
						'</thead>',
		contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>',
		footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'
	};
	DPGlobal.template = '<div class="editable-datepicker">'+
							'<div class="editable-datepicker-days">'+
								...
								'</table>'+
							'</div>'+
							'<div class="editable-datepicker-months">'+
								'<table class="table-condensed">'+
									DPGlobal.headTemplate+
								...
								'</table>'+
							'</div>'+
							'<div class="editable-datepicker-years">'+
								'<table class="table-condensed">'+
									DPGlobal.headTemplate+
									DPGlobal.contTemplate+
									DPGlobal.footTemplate+
	...
	* ================== */
	...
	$(document).on(
		'focus.editable-datepicker.data-api click.editable-datepicker.data-api',
